...
def display_flow(img, flow, stride=40): # flow 그리는 부분 # stride 마다 움직여서 40번에 한번씩 그려준다.
...
cap = cv2.VideoCapture('C:/Users/user/Desktop/traffic.mp4')
...
# 이후 알고리즘은 calcOpticalFlowFarneback 말고 다른 방식으로. 
# 그건 느리지만 더 정확함. 대신 이 알고리즘이 더 빠르다