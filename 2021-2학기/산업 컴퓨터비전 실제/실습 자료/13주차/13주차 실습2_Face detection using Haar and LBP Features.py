...
haar_face_cascade = cv2.CascadeClassifier('C:/Users/user/PycharmProjects/test1/haarcascade_frontalface_default.xml')
detect_faces('C:/Users/user/PycharmProjects/test1/faces.mp4', haar_face_cascade, ' Haar cascade face detector')

lbp_face_cascade = cv2.CascadeClassifier()
lbp_face_cascade.load('C:/Users/user/PycharmProjects/test1/lbpcascade_frontalface.xml')
